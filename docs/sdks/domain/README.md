...
import { domainCreate } from "dokploy/funcs/domainCreate.js";
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { domainByApplicationId } from "dokploy/funcs/domainByApplicationId.js";
...
async function run() {
  const result = await dokploy.domain.byComposeId({
    composeId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { domainByComposeId } from "dokploy/funcs/domainByComposeId.js";
...
async function run() {
  const res = await domainByComposeId(dokploy, {
    composeId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("domainByComposeId failed:", res.error);
  }
}
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { domainGenerateDomain } from "dokploy/funcs/domainGenerateDomain.js";
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { domainUpdate } from "dokploy/funcs/domainUpdate.js";
...
async function run() {
  const result = await dokploy.domain.get({
    domainId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { domainGet } from "dokploy/funcs/domainGet.js";
...
async function run() {
  const res = await domainGet(dokploy, {
    domainId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("domainGet failed:", res.error);
  }
}
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { domainDelete } from "dokploy/funcs/domainDelete.js";
