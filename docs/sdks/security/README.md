...
async function run() {
  const result = await dokploy.security.create({
    applicationId: "<id>",
...
import { securityCreate } from "dokploy/funcs/securityCreate.js";
...
async function run() {
  const res = await securityCreate(dokploy, {
    applicationId: "<id>",
    username: "Jaida.Zulauf",
    password: "K9baGIdLMCnW0iF",
  });
  if (res.ok) {
    ...
    console.log("securityCreate failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.security.get({
    securityId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { securityGet } from "dokploy/funcs/securityGet.js";
...
async function run() {
  const res = await securityGet(dokploy, {
    securityId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("securityGet failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.security.delete({
    securityId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { securityDelete } from "dokploy/funcs/securityDelete.js";
...
async function run() {
  const res = await securityDelete(dokploy, {
    securityId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("securityDelete failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.security.update({
    securityId: "<id>",
    username: "Easter19",
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { securityUpdate } from "dokploy/funcs/securityUpdate.js";
...
async function run() {
  const res = await securityUpdate(dokploy, {
    securityId: "<id>",
    username: "Easter19",
    password: "lzeP1olfVZ7Co23",
  });
  if (res.ok) {
    ...
    console.log("securityUpdate failed:", res.error);
  }
}
