...
async function run() {
  const result = await dokploy.deployment.get({
    applicationId: "<id>",
  });
...
import { deploymentGet } from "dokploy/funcs/deploymentGet.js";
...
async function run() {
  const res = await deploymentGet(dokploy, {
    applicationId: "<id>",
  });
  if (res.ok) {
    ...
    console.log("deploymentGet failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.deployment.allByCompose({
    composeId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { deploymentAllByCompose } from "dokploy/funcs/deploymentAllByCompose.js";
...
async function run() {
  const res = await deploymentAllByCompose(dokploy, {
    composeId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("deploymentAllByCompose failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.deployment.allByServer({
    serverId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { deploymentAllByServer } from "dokploy/funcs/deploymentAllByServer.js";
...
async function run() {
  const res = await deploymentAllByServer(dokploy, {
    serverId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("deploymentAllByServer failed:", res.error);
  }
}
