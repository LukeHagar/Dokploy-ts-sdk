...
import { composeCreate } from "dokploy/funcs/composeCreate.js";
...
async function run() {
  const result = await dokploy.compose.getOne({
    composeId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeGetOne } from "dokploy/funcs/composeGetOne.js";
...
async function run() {
  const res = await composeGetOne(dokploy, {
    composeId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("composeGetOne failed:", res.error);
  }
}
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeUpdate } from "dokploy/funcs/composeUpdate.js";
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeDelete } from "dokploy/funcs/composeDelete.js";
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeCleanQueues } from "dokploy/funcs/composeCleanQueues.js";
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeFetchSourceType } from "dokploy/funcs/composeFetchSourceType.js";
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeRandomizeCompose } from "dokploy/funcs/composeRandomizeCompose.js";
...
async function run() {
  const result = await dokploy.compose.getConverted({
    composeId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeGetConverted } from "dokploy/funcs/composeGetConverted.js";
...
async function run() {
  const res = await composeGetConverted(dokploy, {
    composeId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("composeGetConverted failed:", res.error);
  }
}
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeDeploy } from "dokploy/funcs/composeDeploy.js";
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeRedeploy } from "dokploy/funcs/composeRedeploy.js";
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeStop } from "dokploy/funcs/composeStop.js";
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeGetDefaultCommand } from "dokploy/funcs/composeGetDefaultCommand.js";
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeRefreshToken } from "dokploy/funcs/composeRefreshToken.js";
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeDeployTemplate } from "dokploy/funcs/composeDeployTemplate.js";
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeGetTemplates } from "dokploy/funcs/composeGetTemplates.js";
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { composeGetTags } from "dokploy/funcs/composeGetTags.js";
