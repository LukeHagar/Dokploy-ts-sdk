...
<!-- UsageSnippet language="typescript" operationID="stripe-createCheckoutSession" method="post" path="/stripe.createCheckoutSession" -->
```typescript
import { Dokploy } from "dokploy";
...
<!-- UsageSnippet language="typescript" operationID="stripe-createCustomerPortalSession" method="post" path="/stripe.createCustomerPortalSession" -->
```typescript
import { Dokploy } from "dokploy";
