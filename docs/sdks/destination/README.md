...
async function run() {
  const result = await dokploy.destination.create({
    name: "<value>",
    accessKey: "<value>",
    bucket: "<value>",
    region: "<value>",
...
import { destinationCreate } from "dokploy/funcs/destinationCreate.js";
...
async function run() {
  const res = await destinationCreate(dokploy, {
    name: "<value>",
    accessKey: "<value>",
    bucket: "<value>",
    region: "<value>",
  ...
  if (res.ok) {
    ...
    console.log("destinationCreate failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.destination.testConnection({
    name: "<value>",
    accessKey: "<value>",
    bucket: "<value>",
    region: "<value>",
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { destinationTestConnection } from "dokploy/funcs/destinationTestConnection.js";
...
async function run() {
  const res = await destinationTestConnection(dokploy, {
    name: "<value>",
    accessKey: "<value>",
    bucket: "<value>",
    region: "<value>",
  ...
  if (res.ok) {
    ...
    console.log("destinationTestConnection failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.destination.getOne({
    destinationId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { destinationGetOne } from "dokploy/funcs/destinationGetOne.js";
...
async function run() {
  const res = await destinationGetOne(dokploy, {
    destinationId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("destinationGetOne failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.destination.get();
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { destinationGet } from "dokploy/funcs/destinationGet.js";
...
async function run() {
  const res = await destinationGet(dokploy);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("destinationGet failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.destination.remove({
    destinationId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { destinationRemove } from "dokploy/funcs/destinationRemove.js";
...
async function run() {
  const res = await destinationRemove(dokploy, {
    destinationId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("destinationRemove failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.destination.update({
    name: "<value>",
    accessKey: "<value>",
    bucket: "<value>",
    region: "<value>",
...
```typescript
import { DokployCore } from "dokploy/core.js";
import { destinationUpdate } from "dokploy/funcs/destinationUpdate.js";
...
async function run() {
  const res = await destinationUpdate(dokploy, {
    name: "<value>",
    accessKey: "<value>",
    bucket: "<value>",
    region: "<value>",
  ...
  if (res.ok) {
    ...
    console.log("destinationUpdate failed:", res.error);
  }
}
